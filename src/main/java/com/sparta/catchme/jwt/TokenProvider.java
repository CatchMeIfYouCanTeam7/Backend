package com.sparta.catchme.jwt;
...
import com.sparta.catchme.repository.RefreshTokenRepository;
import com.sparta.catchme.service.UserDetailsServiceImpl;
import com.sparta.catchme.shared.Authority;
...
public class TokenProvider {
  ...
  private static final long ACCESS_TOKEN_EXPIRE_TIME = 1000 * 60 * 5;       //3일
  ...
  public boolean validateToken(String token) {
    try {
      Jwts.parserBuilder().setSigningKey(key).build().parseClaimsJws(token);   // 베어러 빼고 토큰 넣기.
      return true;
